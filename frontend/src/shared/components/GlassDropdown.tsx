    ...
    <div className="relative">
      ...
      <button
        className={`flex items-center gap-2 px-5 py-3 rounded-[14px] backdrop-blur-[25px] border transition-all ${
          isDark
            ? "bg-white/[0.08] border-white/20 hover:bg-white/[0.12] hover:border-[#e8c571]/40"
          ...
          >
            <div className="py-2">
              {options.map((option) => (
                <button
                  key={option}
                  className={`w-full px-5 py-2.5 text-left text-[13px] font-semibold transition-colors focus:outline-2 focus:outline-offset-2 ${
                    isDark
                      ? "text-[#e8dfd0] hover:bg-[#4a3e30] focus:outline-[#f1b400]"
                      : "text-[#2d2820] hover:bg-[#c9b8a0] focus:outline-[#a2792c]"
                  }`}
