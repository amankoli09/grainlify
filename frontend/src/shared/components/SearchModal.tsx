        ...
        <div className="p-12">
          ...
          <div
            className={`relative h-[64px] rounded-[32px] mb-12 transition-colors ${
              darkTheme
                ? "bg-[#3a3428]/80 border border-white/20"
          ...
          >
            <div className="absolute inset-0 flex items-center px-6">
              ...
              <input
                ...
                autoFocus
                className={`flex-1 bg-transparent text-[16px] transition-colors focus:outline-2 focus:outline-offset-2 ${
                  darkTheme
                    ? "text-white placeholder:text-white/40 focus:outline-[#f1b400]"
                    : "text-[#2d2820] placeholder:text-black/40 focus:outline-[#a2792c]"
                }`}
              />
              <button
              ...
              <button
                onClick={onClose}
                className={`absolute top-6 right-6 w-10 h-10 rounded-full flex items-center justify-center transition-all hover:scale-105 focus:outline-2 focus:outline-offset-2 ${
                  darkTheme
                    ? "bg-white/5 hover:bg-white/10 text-white/60 hover:text-white/80 focus:outline-[#f1b400]"
                    : "bg-black/5 hover:bg-black/10 text-black/60 hover:text-black/80 focus:outline-[#a2792c]"
                }`}
              >
                darkTheme ? "text-[#f5efe5]" : "text-[#2d2820]"
              }`}
